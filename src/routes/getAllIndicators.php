...
$app->post('/api/AlienVault/getAllIndicators', function ($request, $response) {
    ...
    $optionalParams = ['limit'=>'limit','page'=>'page','types'=>'types','modifiedSince'=>'modified_since'];
    $bodyParams = [
       'query' => ['modified_since','types','limit','page']
    ];
